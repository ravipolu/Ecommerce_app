...
export const DELATE_PRODUCT_REQUEST = "DELATE_PRODUCT_REQUEST";
export const DELATE_PRODUCT_SUCCESS = "DELATE_PRODUCT_SUCCESS";
export const DELATE_PRODUCT_RESET = "DELATE_REVIEW_RESET";
export const DELATE_PRODUCT_FAIL = "DELATE_PRODUCT_FAIL";
