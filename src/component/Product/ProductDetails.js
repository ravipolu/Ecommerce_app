...
const ProductDetails = () => {
    ...
    useEffect(() => {
        ...
        if (reviewError) {
            alert.error(reviewError)    // yaha se error return kar dege but iss ke baad tho hum logo ko error bhi clear karna hota hai na iss leye CLEAR_ERROR use kare ge
            dispatch(clearErrors())
        }
        if (success) {
